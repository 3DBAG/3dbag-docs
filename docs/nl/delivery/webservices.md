De webservices geven de mogelijkheid om met queries in de vorm van een URL te specificeren welke 3D BAG gebouwen je wil downloaden. Dit kan met behulp van bijvoorbeeld QGIS of FME handig gedaan worden.
